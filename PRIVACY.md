...
**אף אחד.** האפליקציה אינה אוספת, אינה שולחת ואינה משתפת מידע אישי כלשהו.

- אין חשבון משתמש ואין התחברות.
- אין שרת — האפליקציה עובדת גם ללא חיבור לאינטרנט.
- אין רכיבי מעקב, אנליטיקס או פרסום של צד שלישי.
